 ...
 *  gcc main_template_MarieHelene.c lib/phasor.c -Ilib -lm -lportaudio -o main_template_MH
 *
 * Compile on Windows with:
 *  gcc main_template_MarieHelene.c lib/phasor.c -Ilib -lm -lportaudio -o main_template_MH.exe
 *
 * Run on linux and MacOS with:
 *  ./main_template_MH
 *
 * Run on Windows with:
 *  main_template_MH.exe
